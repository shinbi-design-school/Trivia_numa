    ...
    <div class="result-container">
        ...
        <div class="result-button">
        	<form method="post" action="SaveResultServlet">
            	<p>結果を保存しますか？</p>
            	名前<input class="resultname" type="text" name="name">
            	<%if(error != null){ %>
            	<div id="error"><%= error %></div>
            	<%} %>
            	<button class="resultbutton" type="submit" name="save" value="yes">はい</button>
            	<button class="resultbutton" type="submit" name="save" value="no">いいえ</button>
        	</form>
		</div>
    </div>
